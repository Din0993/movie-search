  ...
  .addEventListener("click", function (e) {
    if (e.target.className === "top-rated-tv-shows-by-genre__genre") {
      ...
      getMoviesInTheatersTop100(1)
        ...
        .then(() => {
          for (let i = 2; i < 50; i++) {
            getMoviesInTheatersTop100(i).then((data) => {
