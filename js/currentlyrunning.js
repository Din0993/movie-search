  ...
  .addEventListener("click", function (e) {
    if (e.target.className === "top-rated-tv-shows-by-genre__genre") {
      ...
      getTop100TvShowAiring(1)
        ...
        .then(() => {
          for (let i = 2; i < 50; i++) {
            getTop100TvShowAiring(i).then((data) => {
