  ...
  .addEventListener("click", function (e) {
    if (e.target.className === "top-rated-tv-shows-by-genre__genre") {
      ...
      getTop100TvShowAiringToday(1)
        ...
        .then(() => {
          for (let i = 2; i < 50; i++) {
            getTop100TvShowAiringToday(i).then((data) => {
