                ...
                getTop100TvShowMostPopular(5)
                  ...
                  .then(() => {
                    ...
                    top100MostPopular.forEach((mov) => {
                      let markup = ``;
                      markup += `
                      <div class="popular-movies__movie-container__card" data-tvid="${
                        mov.id
                      }" >
                      <img
                        src="https://image.tmdb.org/t/p/w154${mov.poster_path}"
                        class="
                        ...
                        >
                          ...
                          <p
                            class="
                              ...
                              popular-movies__movie-container__card__overview__text
                            "
                          >First air date: ${mov.first_air_date}</p>
                        </div>
                        <a href="/pages/details/tvshow/index.html"
  ...
  .addEventListener("click", function (e) {
    if (e.target.className === "top-rated-tv-shows-by-genre__genre") {
      ...
      getTop100TvShowMostPopular(1)
        ...
        .then(() => {
          for (let i = 2; i < 50; i++) {
            getTop100TvShowMostPopular(i).then((data) => {
              ...
              topRatedMoviesArr2.forEach((mov) => {
                if (movieGenreCnt2 <= topRatedMoviesArr2.length) {
                  if (mov.genre_ids.includes(genreId)) {
                    ...
                    markup = "";
                    markup += `
                    <div class="popular-movies__movie-container__card" data-tvid="${mov.id}">
                    <img
